...
//
// ສຳຄັນ — ຖ້າແຖບນີ້ (ສົດ) ໂຊວ໌ແຕ່ຕອນເຂົ້າສູ່ລະບົບເປັນແອດມິນ ແຕ່ລູກຄ້າທົ່ວໄປບໍ່ເຫັນ:
// ສາເຫດແມ່ນ Row Level Security (RLS) ຂອງຕາຕະລາງ orders / topup_requests ໃນ Supabase
// ອະນຸຍາດໃຫ້ອ່ານໄດ້ສະເພາະເຈົ້າຂອງແຖວ ຫຼືແອດມິນເທົ່ານັ້ນ — ບໍ່ແມ່ນບັນຫາຢູ່ໃນໄຟລ໌ນີ້
// ໃຫ້ແລ່ນ SQL ນີ້ໃນ Supabase SQL editor ເພື່ອເປີດໃຫ້ທຸກຄົນອ່ານ "ສະເພາະແຖວທີ່ສຳເລັດແລ້ວ" ໄດ້:
//
// alter table orders enable row level security;
// create policy "public can view completed orders" on orders
//   for select using (status in ('paid','completed','success','delivered','done'));
//
// alter table topup_requests enable row level security;
// create policy "public can view approved topups" on topup_requests
