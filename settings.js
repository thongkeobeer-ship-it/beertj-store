...
// ໝາຍເຫດສຳຄັນ: ຊື່ຮ້ານທີ່ແອດມິນພິມ/ແປະໃສ່ໃນຫ້ອງຄວບຄຸມ ບາງເທື່ອເປັນໂຕໜັງສືພິເສດ
// (bold unicode ເຊັ່ນ 𝐘𝐔𝐌𝐈𝐍 𝐒𝐇𝐎𝐏 ທີ່ຄັດລອກມາຈາກທີ່ອື່ນ) ຟອນຂອງເວັບບໍ່ມີໂຕນັ້ນ -> ບາງ browser/ມືຖື
// ຈະບໍ່ໂຊວ໌ຫຍັງເລີຍ (ຫາຍໄປທັງໝົດ, ບໍ່ແມ່ນແຄ່ໂຊວ໌ເປັນກ່ອງ) ຈຶ່ງຕ້ອງ .normalize('NFKD') ແລ້ວຕັດ
// ໂຕ combining mark ອອກ ເພື່ອປ່ຽນກັບເປັນໂຕປົກກະຕິກ່ອນສະເໝີ ບໍ່ວ່າແອດມິນຈະພິມຫຍັງມາກໍ່ຕາມ
function sanitizeStoreName(name) {
  return name
    .normalize('NFKD')
    .replace(/[\u0300-\u036f]/g, ''); // ຕັດ combining diacritical marks ທີ່ອາດຕິດມາຈາກ normalize
}
