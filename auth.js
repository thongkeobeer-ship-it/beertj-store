...
function injectWalletStyles() {
  ...
  style.textContent = `
    .wallet-chip{
      ...
      background:linear-gradient(135deg, rgba(124,58,237,0.12), rgba(32,181,106,0.08));
      border:1px solid rgba(124,58,237,0.28);
      font-family:'Chakra Petch','Noto Sans Thai',sans-serif;
      font-weight:700;font-size:12.5px;color:#7c3aed;
      white-space:nowrap;transition:box-shadow .2s ease;
    }
    .wallet-chip:hover{ box-shadow:0 0 0 3px rgba(124,58,237,0.12); }
    .wallet-chip svg{ width:15px;height:15px;stroke:#7c3aed;flex-shrink:0; }
