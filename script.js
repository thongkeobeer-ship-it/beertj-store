...
// === reveal ທົ່ວໄປ: ໃຫ້ card (ສິນຄ້າ ຫຼື ໝວດໝູ່) ຄ່ອຍໆເດັ່ນຂຶ້ນມາເທື່ອລະໃບ ເມື່ອເລື່ອນລົງມາເຫັນ ===
// ຮູບແບບ Premium: ໃບທີ 1 ເລື່ອນເຂົ້າມາຈາກຊ້າຍ, ໃບທີ 2 ຈາກຂວາ, ສະຫຼັບກັນໄປເລື່ອຍໆ (ຊ້າຍ→ຂວາ→ຊ້າຍ→ຂວາ)
// ພ້ອມ fade + blur ເລັກນ້ອຍ ແລ້ວຄ່ອຍຄົມຂຶ້ນ ແລະ ແສງ glow ບາງໆອ້ອມຂອບເມື່ອເຂົ້າສູ່ຈໍ
// ໝາຍເຫດ: ບໍ່ໃຊ້ scroll-linked transform ອີກຕໍ່ໄປ (ອັນເກົ່າເຮັດໃຫ້ກະຕຸກ) — ໃຊ້ IntersectionObserver
// trigger ຄັ້ງດຽວຕໍ່ card ແລ້ວປ່ອຍໃຫ້ CSS transition ຈັດການຄວາມນຸ້ມນວນທັງໝົດ
function revealCardsOnScroll(cards){
  ...
  const revealObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      // ບໍ່ unobserve ອີກຕໍ່ໄປ -> ໃຫ້ animation ຫຼິ້ນຄືນທຸກຄັ້ງທີ່ການ໌ດເຂົ້າ/ອອກຈໍ ບໍ່ວ່າຈະເລື່ອນຂຶ້ນ ຫຼື ລົງ
  ...
  // rootMargin ສະໝະສະໝານກັນທັງເທິງ-ລຸ່ມ (-10% ທັງສອງຝັ່ງ) -> ການ໌ດເຂົ້າ/ອອກຈໍ
  // ຄິດໄລ່ຈາກເງື່ອນໄຂດຽວກັນ ບໍ່ວ່າຈະເລື່ອນຂຶ້ນຫຼືລົງ (ອັນເກົ່າ margin ລຸ່ມ -30px ຝ່າຍດຽວ
  // ເຮັດໃຫ້ຕອນເລື່ອນຂຶ້ນ ການ໌ດຜິດໃບຖືກເຊື່ອງ)
